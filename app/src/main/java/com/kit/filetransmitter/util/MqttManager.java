...
import com.kit.filetransmitter.chat.ChatCallback;
...
public class MqttManager {
	...
	private MqttManager(ChatCallback chatCallBack) {
		this.chatCallBack = chatCallBack;
	}

	public static MqttManager getInstance(ChatCallback context) {
		if (null == mInstance) {
	...
	class MyMqttCallBack implements MqttCallbackExtended {
		...
		public void messageArrived(String topic, MqttMessage message) throws Exception {
			try {
				...
				System.out.println("payload = " + message.toString());
				chatCallBack.onMessageArrive(topic, payload);
		...
		public void deliveryComplete(IMqttDeliveryToken token) {
			try {
				...
				chatCallBack.onDeliveryComplete(topic, payload);
			} catch (MqttException e) {
				e.printStackTrace();
			}
		}
		...
		public void connectComplete(boolean reconnect, String serverURI) {
			Log.d("connectComplete", serverURI);
		}
	}
